# Matt Muszynski Curriculum Vitae
Los Angeles, CA | mrmuszynski@gmail.com | [LinkedIn](https://www.linkedin.com/in/mrmuszynski/) | [GitHub](https://github.com/mrmuszynski)

## Professional Profile
Multidisciplinary Systems Engineer, Software Engineer, and Spacecraft Operator with a decade of experience across high-profile space missions. Uniquely positioned having served as a software developer, an end-user, and a product lead seamlessly translating needs between the two communities. Expert in the end-to-end mission lifecycle (NASA Phases A–E)—spanning requirement definition, system design, implementation, V&V, and real-time flight operations. Proven versatile across a diverse portfolio, scaling from small hosted payloads to flagship missions exploring Low Earth Orbit, the Martian surface, Jupiter, and extra-solar systems.

Defined by extreme adaptability and a proven record across radically disparate fields, with a career encompassing both cross-functional NASA mission leadership and award-winning performances as a world-class classical tubist in New York City. Highly skilled at identifying operational commonalities across bespoke projects to build robust, scalable systems where failure is not an option.

## Technical Skills

* **Programming & Scripting:** Python (Expert), Web Development, Bash, Perl, IDL. 
* **Working/Systems Engineering Knowledge (Software Engineering):** C++, C, Make, Perl, IDL, VBA, SQL & Relational Databases, Elasticsearch.
* **Working/Systems Engineering Knowledge (Spacecraft Subsystems):** Thermal, Power, Telecom, Data Management, Propulsion, ADCS/GNC.
* **Working/Systems Engineering Knowledge (Other Frameworks):** JPL Flight Software, F-Prime, Basilisk Astrodynamics, STK, Spice.
* **Software Engineering & Architecture:** Software/Systems Architecture, Open-Source Governance & Product Management, Core/Adaptation Modeling, Library Atomization.
* **Spacecraft Systems & Flight Ops:** End-to-End Mission Lifecycle (Phases A–E), Autonomous Uplink Planning/Downlink Analysis, Telemetry Dictionaries (AMPCS XML), Sequence Formats (SeqJSON, RML, .seq, CSTOL, FSTOL), Static Flight Rule Checking, Auto-Dispositioning, Digital Twin Simulation. 
* **DevOps, Requirements, & QA:** Git (Expert), Docker, Jenkins CI/CD Pipelines, Automated Unit Testing (`pytest`), Auto-generated Documentation (MkDocs/Sphinx), Jira, IBM DOORS Next Generation, JAMA, Jupyter Notebooks, JupyterLab.
* **Leadership & Core Competencies:** First-Principles Problem Solving, Functional Decomposition, Product Management, Cross-functional Communication, "Operator-Developer" Training and Mentorship, Meta-learning & Rapid Skill Acquisition, Translating Operator Needs to Developer Requirements.
...
* Worked on the Curiosity rover uplink team, synthesizing science team inputs into a single coherent plan
* Converted those synthesized plans into sequences to be uplinked to and executed by the Curiosity rover

## Professional Experience (LASP)

**Command Controller** | *Laboratory for Atmospheric and Space Physics* | 2014-2018
*Boulder, CO*

**Graduate Lead: Aeronomy of Ice in the Mesosphere (AIM) Mission** | 2017-2018

* Managed 5 student subsystem teams
* Organized preparation for “full sun” campaign and lead team through significant anomalies
* Redesigned AIM ground autonomy to improve uplink capabilities by ~50%

**Graduate Lead: Tracking and Data Relay Satellite (TDRS) Scheduling** | 2016-2018

* Lead a team of 7 graduate and undergraduate students
* Owned process, procedures, software, and operator shift scheduling scheduling for TDRS scheduling
* Scheduled health and safety critical communication SORCE and AIM spacecraft

**Command Controller** | 2014-2018

* Certified to operate five NASA satellite missions
* Major anomaly (Kepler, AIM, SORCE) and commissioning (MMS) support
* Planning and scheduling for AIM, SORCE, QuikSCAT, and TCTE
...
* Lead a team of 13 graduate students through initial requirements definition to final delivery to customer.
* Designed a first principles model of optical navigation camera, including field of view calculation, starfield limiting, addition of planet/asteroid navigation beacons, and models for point spread, rasterization, and camera noise
* -Developed C++ modules, unit tests, and documentation to extend open-source Basilisk astrodynamics software

## Professional Experience (Prior to LASP)

**Parts, Materials, Process, and Design Assurance Intern** | *Lockheed Martin Space Systems* | 2013-2014
*Littleton, CO*

* Maintained parts database input checking tool in VBA.

**Associate Buyer—Sheet Music, Books, and Textbooks** | *The Juilliard Store* | 2008-2013
*New York, NY*

* Lead the development and redesign of TheJuilliardStore.com
* Maintained inventory databases with 25,000 (in store) and 50,000 (online) unique records
* Annual buying and inventory planning for ~$250,000 of sheet music, general interest books, and textbooks

**Freelance Tuba Player** | *Self* | 2007-2013
*New York, NY*
...
**397 Line Management Teamtools Studio Peer Review** | *Presenter/Organizer* | 2025

* Presented Teamtools studio guiding philosophies and architecture
...
* **2011 New York Innovative Theatre Awards** — Nominee – Outstanding Ensemble, Radio Purgatory
* **2011 New York Innovative Theatre Awards** – Nominee — Outstanding Performance Art Production, Radio Purgatory
* **2008 Eisenberg-Fried Concerto Competition** — Winner — Performed John Stevens's  "Journey for Tuba and Orchestra" with Manhattan School of Music Sinfonia Orchestra.
